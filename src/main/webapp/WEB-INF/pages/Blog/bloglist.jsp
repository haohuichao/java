...
<section id="bloglist-left" class="clearfix">
	...
	<div class="bloglist">
        ...
        <img class="bloglist-img" src="${ctx}/staticfile/images/articles/article1_bl.png" alt="Article 1" />
    ...
    <div class="bloglist">
        ...
        <img class="bloglist-img" src="${ctx}/staticfile/images/articles/article2_bl.png" alt="Article 2" />
    ...
    <div class="bloglist">
        ...
        <img class="bloglist-img" src="${ctx}/staticfile/images/articles/article3_bl.png" alt="Article 3" />
    ...
    <div class="bloglist">
        ...
        <img class="bloglist-img" src="${ctx}/staticfile/images/articles/article4_bl.png" alt="Article 4" />
    ...
    <div class="bloglist">
        ...
        <img class="bloglist-img" src="${ctx}/staticfile/images/articles/article5_bl.png" alt="Article 5" />
        ...
        <img class="bloglist-img" src="${ctx}/staticfile/images/articles/article1_bl.png" alt="Article 6" />
    ...
    <div class="bloglist">
        ...
        <img class="bloglist-img" src="${ctx}/staticfile/images/articles/article2_bl.png" alt="Article 7" />
    ...
    <div class="bloglist">
        ...
        <img class="bloglist-img" src="${ctx}/staticfile/images/articles/article3_bl.png" alt="Article 8" />
    ...
    <div class="bloglist">
        ...
        <img class="bloglist-img" src="${ctx}/staticfile/images/articles/article4_bl.png" alt="Article 9" />
    ...
    <div class="bloglist">
        ...
        <img class="bloglist-img" src="${ctx}/staticfile/images/articles/article5_bl.png" alt="Article 10" />
