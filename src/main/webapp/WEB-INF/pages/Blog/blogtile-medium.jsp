...
<div id="blogs" class="clearfix centered">
	<div class="tile medium">
        ...
        <img class="tile-pre-img" src="${ctx}/staticfile/images/articles/article1_med.png" alt="Article 1" />
    ...
    <div class="tile medium">
        ...
        <img class="tile-pre-img" src="${ctx}/staticfile/images/articles/article2_med.png" alt="Article 2" />
    ...
    <div class="tile medium">
        ...
        <img class="tile-pre-img" src="${ctx}/staticfile/images/articles/article3_med.png" alt="Article 3" />
    ...
    <div class="tile medium">
        ...
        <img class="tile-pre-img" src="${ctx}/staticfile/images/articles/article4_med.png" alt="Article 4" />
    ...
    <div class="tile medium">
        ...
        <img class="tile-pre-img" src="${ctx}/staticfile/images/articles/article5_med.png" alt="Article 5" />
        ...
        <img class="tile-pre-img" src="${ctx}/staticfile/images/articles/article1_med.png" alt="Article 6" />
    ...
    <div class="tile medium">
        ...
        <img class="tile-pre-img" src="${ctx}/staticfile/images/articles/article2_med.png" alt="Article 7" />
    ...
    <div class="tile medium">
        ...
        <img class="tile-pre-img" src="${ctx}/staticfile/images/articles/article3_med.png" alt="Article 8" />
    ...
    <div class="tile medium">
        ...
        <img class="tile-pre-img" src="${ctx}/staticfile/images/articles/article4_med.png" alt="Article 9" />
    ...
    <div class="tile medium">
        ...
        <img class="tile-pre-img" src="${ctx}/staticfile/images/articles/article5_med.png" alt="Article 10" />
