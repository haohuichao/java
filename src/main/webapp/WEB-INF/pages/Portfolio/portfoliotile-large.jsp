...
<!-- Tile 1 -->
    ...
    <img class="tile-pre-img" src="${ctx}/staticfile/images/portfolio/item1_large_1.png" alt="Project 1" />
    </a>
    </div>
...
<!-- Tile 2 -->
    ...
    <img class="tile-pre-img" src="${ctx}/staticfile/images/portfolio/item2_large.png" alt="Project 2" />
    </a>
    </div>
    <!-- Lightbox Article Preview -->
    <div class="tile-pre">
...
<!-- Tile 3 -->
    ...
    <img class="tile-pre-img" src="${ctx}/staticfile/images/portfolio/item3_large.png" alt="Project 3" />
    </a>
    </div>
<!-- Tile 4 -->   
    <div class="tile large graphic-design">
    ...
    <img class="tile-pre-img" src="${ctx}/staticfile/images/portfolio/item4_large.png" alt="Project 4" />
    </a>
    </div>
<!-- Tile 5 -->
    <div class="tile large graphic-design">
    ...
    <img class="tile-pre-img" src="${ctx}/staticfile/images/portfolio/item5_large.png" alt="Project 5" />
    </a>
    </div>
<!-- Tile 6 -->
    <div class="tile large illustration">
    ...
    <img class="tile-pre-img" src="${ctx}/staticfile/images/portfolio/item6_large.png" alt="Project 6" />
    </a>
    </div>
<!-- Tile 7 -->
    <div class="tile large illustration">
    ...
    <img class="tile-pre-img" src="${ctx}/staticfile/images/portfolio/item7_large.png" alt="Project 7" />
    </a>
    </div>
<!-- Tile 8 -->
    <div class="tile large graphic-design">
    ...
    <img class="tile-pre-img" src="${ctx}/staticfile/images/portfolio/item8_large.png" alt="Project 8" />
    </a>
    </div>
