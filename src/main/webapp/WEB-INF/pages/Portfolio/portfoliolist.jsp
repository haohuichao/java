...
<!-- END FILTER -->
	...
	<div class="portfoliolist illustration">
        ...
        <img class="portfoliolist-img" src="${ctx}/staticfile/images/portfolio/item1_pl.png" alt="Project 1" />
        </a>
    </div>
